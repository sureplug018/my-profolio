  ...
  return (
    <Container type='container'>
      <div className='w-[90%] text-center m-auto lg:w-[70%]'>
        ...
        <p>
          Outside of coding, I&apos;m an avid gamer, diving into immersive video
          game worlds that spark creativity and sharpen my strategic thinking.
          I&apos;m equally excited about learning the latest tech innovations,
          from AI advancements to cutting-edge frameworks, keeping me inspired
          and ahead of the curve in the ever-evolving tech landscape.
        </p>
      </div>
    </Container>
  );
